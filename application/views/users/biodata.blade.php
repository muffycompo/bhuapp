		...
		<fieldset>
			...
			<p>
				<div class="distanceLeft">
					{{ Form::radio('has_reason',1,($biodata->has_reason == 1)? true : false,array('class'=>'inputStyleChk','id'=>'if_suspended')) }}
			...
			<p>
				<div class="distanceLeft">
					{{ Form::radio('has_reason',2,($biodata->has_reason == 2)? true : false,array('class'=>'inputStyleChk','id'=>'if_expelled')) }}
			...
			<p>
				<div class="distanceLeft">
					{{ Form::radio('has_reason',3,($biodata->has_reason == 3)? true : false,array('class'=>'inputStyleChk','id'=>'if_denied_admission')) }}
